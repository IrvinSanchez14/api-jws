...
if (!defined('PDF_HEADER_TITLE')) {
	define('PDF_HEADER_TITLE', 'Aqui va el titulo tcpdf_autoconfig.php');
}

if (!defined('PDF_HEADER_STRING')) {
	define('PDF_HEADER_STRING', "Autor y link pagina web - lapizzeria.com");
}
