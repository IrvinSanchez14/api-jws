...
if ($_SERVER['REQUEST_METHOD'] == "OPTIONS") {
  ...
  $pdf->Write(0, 'Reporte Nota de envio por tipo de producto', '', 0, 'L', true, 0, false, false, 0);
  ...
  if ($num > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
      extract($row);
      $html .= '<tr ><td align="center">' . $lote . '</td><td align="center">' . $Producto . '</td><td align="center">' . $porcionNombre . '</td><td align="center">' . $Cantidad . '</td><td align="center">' . $FechaVencimiento . '</td><td align="center">' . $Sucursal . '</td></tr>';
    }
    $html .= "</table>";
