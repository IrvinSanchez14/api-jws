...
if ($_SERVER['REQUEST_METHOD'] == "GET" || $_SERVER['REQUEST_METHOD'] == "OPTIONS") {
  ...
  $pdf->Write(0, 'TIPO PRODUCTO', '', 0, 'L', true, 0, false, false, 0);
  ...
  if ($num > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
      extract($row);
      $html .= '<tr><td align="center">' . $IdTipoProducto . '</td><td align="center">' . $Nombre . '</td><td align="center">' . $Descripcion . '</td></tr>';
    }
    $html .= "</table>";
