...
if ($_SERVER['REQUEST_METHOD'] == "DELETE") {
  ...
  4-  "Access-Control-Allow-Methods: DELETE" -- Especificamos el metodo que utilizaremos en nuestra api en este momento sera el DELETE
  ...
  */
  ...
  /* -- Creacion de los datos a insertar --
  ...
  4- se crea un IF donde le colocamos la funcion delete() la cual esta en nuestra clase y si devuelve un valor true ejecuta que el usuario es creado si no un error tendremos en el aplicativo */

  $tipoUsuario->IdTipoUsuario = $data->IdTipoUsuario;

  if ($tipoUsuario->delete()) {
