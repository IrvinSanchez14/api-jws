<?php
	...
	include 'funcs/funcs.php';//se llaman las funciones creadas
	...
	$errors = array();//variable $errors para ir almacenando todos los errores 
	
	if(!empty($_POST))//se valida que el usuario envia el post
	{
		//se reciben los datos mediante metodo post
		$usuario = $mysqli->real_escape_string($_POST['usuario']);
		$password = $mysqli->real_escape_string($_POST['password']);
		
		if(isNullLogin($usuario, $password))//validacion de que los campos no sean nulos mediante la funcion isNullLogin
		{
			$errors[] = "Debe llenar todos los campos";//si uno de los campos o los dos son nulos, nos muestra el mensaje de error 
		}
