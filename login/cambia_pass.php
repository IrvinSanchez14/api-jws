<?php
	...
	$user_id = $mysqli->real_escape_string($_GET['user_id']);//se obtiene el id
	$token = $mysqli->real_escape_string($_GET['token']);//se obtiene el token
	
	if(!verificaTokenPass($user_id, $token))//aqui se verifica que existan estos datos en la BD mediante la funcion verificaTokenPass
	{
